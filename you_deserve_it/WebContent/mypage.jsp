...
<%
	member m = (member)request.getAttribute("vo");
%>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>  
        ...
        <div class="container">
          <div class="row">         
            <div class="col-md-12">
              ...
              <br><br>
                <h2 class="product-title">마이페이지-내정보</h2>
                <ol class="breadcrumb">
                  <li><a href="index.jsp"><i class="ti-home"></i> 홈</a></li>
                  <li class="current">마이페이지-내정보</li>
                </ol>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="right-sideabr">
                <div class="inner-box">
                  ...
                  <h4 >내정보</h4>
                  <ul class="lest item">
                  	<li><a class="active" href="controller.do?command=mypage">- 내 정보 보기</a></li>  
     ...
     <!-- featured jobs -->
        ...
        <!------------------------------------------------------------------------------------------------------------------------------------------ -->
          <!-- graphics designer -->
          <div class="col-md-4 col-sm-6 col-xs-12" style = "width:50%">
            <div class="featured-item" style = "margin-left:10%;">
            
              <div class="featured-wrap">
                <div class="featured-inner">
                
                  <!-- 이미지 -->
                  <figure class="item-thumb" style = "width:200px;height:60%;float:left;margin-right:5%">
                    <a class="hover-effect">
                      <img src="assets/img/glogo/a${grade}.png" alt="" style = "height:38vh;padding-top:20%">
                    </a>
                  </figure>
                  ...
                  <div style = "float:right">
                    <h3 class="job-title" style = "text-align:right"><%=m.getNickname() %></h3>   
                    <div class="adderess" style = "text-align:right"><i class="ti-user"></i>&nbsp;<%=m.getUserid() %></div>
                    <span style = "text-align:right"><i class="ti-email" ></i>&nbsp;<%=m.getEmail() %></span><br>
                    <span style = "text-align:right;"><b style = "color:red">${vo.nickname}</b>님의 레벨은 <b style = "color:red">${grade}</b>입니다.</span>
                    <div style = "margin-top:100%;margin-left:20%;width:110%">
                    <a class="btn btn-xs btn-danger" href="updateInfo.jsp">Edit</a>
                 	 <a class="btn btn-xs btn-danger" href="deleteChk.jsp" onclick="window.open(this.href, '내 정보 삭제', 'width=400, height=150, top=200, left=300, scrollbars=no, status=no, resizable=no'); return false;">Delete</a>
                  	</div>
                  </div>
                  </div>
                </div>
