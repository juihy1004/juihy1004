...
%>
        ...
        <div class="container">
          <div class="row">         
            <div class="col-md-12">
              ...
              <br><br>
                <h2 class="product-title">커뮤니티</h2>
                <ol class="breadcrumb">
	...
	<!-- -------------------------------------------------------------------------------------------------- -->
                ...
                <ul class="nav navbar-nav navbar-right" style = "margin-right : 12%">                 
                  ...
                  <li class="right"><a href="controller.do?command=community" style = "color:#ff4f57"> <b> 커뮤니티 </b> </a></li>
     ...
     <div id="content" style = "padding : 0px">
        <div class="container">        
            ...
            <!-- ---------------------------------------------------------------------------------------- -->
              ...
              <!-- 말머리 -->
           <div>
              <div style = "float:left;width:30%;"> <!-- 20%로 변경 -->
	              
	              	<form  method = "post" action = "controller.do" style = "width:80%">
	              	
	              	<input type = "hidden" name = "command" value = "headtag">
	              	<input type = "hidden" name = "tabloc" value = "community">
	              	
	              		 <select name = "horsehead" id="select-superpower" onchange="location.href=this.value">
	              		 <!--id =   -->
		              	  <option value = "" style = "float:left">말머리</option>
		              	  <option value = "controller.do?&command=headtag&tabloc=community&horsehead=horsehead">전체</option>
		              	  <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C1">건설</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C2">기계</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C3">인쇄.목재.가구.공예</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C4">이용.숙박.여행.오락.스포츠</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C5">음식서비스</option> 
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C6">전기.전자</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C7">정보통신</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C8">경비.청소</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C9">경영.회계.사무</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C10">광업자원</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C11">농림어업</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C12">문화.예술.디자인.방송</option>                                    
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C13">보건.의료</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C14">섬유.의복</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C15">식품.가공</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C16">안전관리</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C17">운전.운송</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C18">재료</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C19">화학</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C20">환경.에너지</option>
                          <option value = "controller.do?&command=headtag&tabloc=community&horsehead=C21">언어.교육</option>
...
%>                 
            <ul class="nav navbar-nav navbar-right" style = "margin-top:2%;">                 
				<li class="active" style = "height:20%"><a href="controller.do?command=writebefore&tabloc=community" class="btn btn-common" style = "border-radius:10px"> 글작성 </a></li>
			</ul>
...
%>  
 ...
 <script type="text/javascript">
	function PageMove(page){
    		location.href = "controller.do?command=community&curpagenum="+page;
    }
</script>   
                 <!-- ---------------------------------------------------------------------------------------- -->
            <!-- ---------------------------------------------------------------------------------------- -->
...
<c:choose>		 
 ...
 <!-- ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ class = col-md-12 끝 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ-->
 <!-- 페이징 검색결과 -->
<script type="text/javascript">

	function categoryPageMove(page){
			var horsehead2 = '<c:out value="${horsehead2}"/>';
			location.href = "controller.do?command=headtag&curpagenum="+page+"&tabloc=community&horsehead="+horsehead2 ;
    }
</script> 
...
<script type="text/javascript">
	...
	function searchPageMove(page){
			...
			location.href = "controller.do?command=searchboard&curpagenum="+page+"&tabloc=community&searchtag="+searchtag+"&boardkeyword="+boardkeyword ;
    }
</script> 
