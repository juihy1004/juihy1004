...
%>
    ...
    <!-- ------------------------------------------------------------------------------------------------------------ -->
    <!-- 기업정보 -->
    <section id="testimonial" class="section" style = "background : url('assets/img/company_bg.jpg')">
      <div class="container">
           ...
           <div class="row">         
            <div class="col-md-12">
              <div class="breadcrumb-wrapper">
                <h2 class="product-title" style = "color:white">기업 정보</h2>
                <ol class="breadcrumb">
                  <li><a href="index.jsp"><i class="ti-home"></i>홈</a></li>
                  <li class="current">기업 정보</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <!-- 1 -->
            <div class="item active text-center">  
              ...
              <img class="img-member" src="${companylist.logo}" alt=""> 
              
              <div class="client-info">
               <h2 class="client-name"><c:out value = "${companylist.dname}"/> <span><c:out value = "${companylist.cname }"/></span></h2>
              </div>
              
              <p><i class="fa fa-quote-left quote-left"></i><a href = "http://${companylist.homepage}" style = "color:#ff4f57"><b><c:out value = "${companylist.homepage}"/></b></a><i class="fa fa-quote-right quote-right"></i><br><br> 
              		<c:out value = "${companylist.industry}"/>  <br> <c:out value = "${companylist.divide}"/> </p>
            </div>
            <!-- ------------------------------------------------------------------------------------------------------------ -->
            </c:forEach>
