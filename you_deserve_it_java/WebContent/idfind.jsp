          ...
          <div class="row">         
            <div class="col-md-12">
              <div class="breadcrumb-wrapper">
                <h2 class="product-title"><br>아이디찾기</h2>
                <ol class="breadcrumb">
              ...
              <div class="my-account-form">
               ...
               <!-- login/register 창 -->
                <ul class="cd-switcher">
                  ...
                  <li><a href="#0"><b>아이디찾기</b></a></li>
                </ul>
                
                <!-- ---------------------------------------------------------------------------------------------------------------- --> 
                <!-- Login -->
                <div id="id="cd-board"" class="is-selected">
                  <div class="page-login-form">
                      ...
                      <!-- 아이디구역 -->
                      <div class="form-group" style = "display:none" id = "idblock">
                        <div class="input-icon">
                          <i class="ti-user" style = "padding-top:1.5%"></i>
                          <input type="text" class="form-control" name = "id" id = "idblockinput">
                        </div>
                      </div> 
                      
                      <!-- login button -->
                      <button class="btn btn-common log-btn" id = "butblock" style = "display:block" onclick = "idfind(document.getElementById('sender-email').value)">아이디 찾기</button>
   ...
   <!-- ------------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    function idfind(str){
    	...
    	$.ajax({
    		...
    		url : "controller.do?command=idfind&email="+str,
    		type : "GET",
    		dataType:"JSON",
    		success:function(data){
    			...
    			if(data.userid==null)
				{
    				$("#idblockinput").val("이메일에 해당하는 아이디가 없습니다.").css("color","red");	
    				$("#butblock2").show();
    				$("#butblock2").text("되돌아가기");
				} else {
					$("#idblockinput").val(data.userid).css("font-weight","bold").css("color","red");
					$("#butblock3").show();
					$("#butblock3").text("로그인");
				}
